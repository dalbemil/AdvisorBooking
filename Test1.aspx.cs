...
public partial class Test1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblStudentID.Text=stID;
             ...
             //{
                 ...
                 Label14.Text = getAvailableID(advisor_Id, date).ToString();
    ...
    {
      // Session["2"] =getAdvisorImage(Convert.ToInt32(TextBox1.Text);
        //try
        //{ Label1.Text = getAdvisorImage(Convert.ToInt32(TextBox1.Text)); }
        //catch{}
    }
}